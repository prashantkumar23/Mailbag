...
app.get("/mailboxes/GMAIL/:mailbox", function (inRequest, inResponse) { return __awaiter(void 0, void 0, void 0, function () {
    var imapWorker, messages, inError_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                console.log("GET /mailboxes (2)", inRequest.params.mailbox);
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                imapWorker = new IMAP.Worker(ServerInfo_1.serverInfo);
                return [4 /*yield*/, imapWorker.listMessagesOfGmail(inRequest.params.mailbox)];
            case 2:
                messages = _a.sent();
                console.log("GET /mailboxes (2): Ok", messages);
                inResponse.json(messages);
...
app.delete("/messages/:mailbox/:id", function (inRequest, inResponse) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                inError_5 = _a.sent();
                console.log("DELETE /messages: Error", inError_5);
                inResponse.send("error");
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
...
app.post("/messages", function (inRequest, inResponse) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                inError_6 = _a.sent();
                console.log("POST /messages: Error", inError_6);
                inResponse.send("error");
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
...
app.get("/contacts", function (inRequest, inResponse) { return __awaiter(void 0, void 0, void 0, function () {
    var contactsWorker, contacts, inError_7;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 3:
                inError_7 = _a.sent();
                console.log("GET /contacts: Error", inError_7);
                inResponse.send("error");
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
...
app.post("/contacts", function (inRequest, inResponse) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                inError_8 = _a.sent();
                console.log("POST /contacts: Error", inError_8);
                inResponse.send("error");
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
...
// TEST ROUTE  *****************************************************
app.get('/selectedInbox', function (inRequest, inResponse) { return __awaiter(void 0, void 0, void 0, function () {
    var imapWorker, response_1, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                imapWorker = new IMAP.Worker(ServerInfo_1.serverInfo);
                return [4 /*yield*/, imapWorker.getSelectedMailbox()];
            case 2:
                response_1 = _a.sent();
                inResponse.send(response_1);
                return [3 /*break*/, 4];
            case 3:
                error_1 = _a.sent();
                inResponse.send(error_1);
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
    });
}); });
app.get('/selectedInboxMessageBody/:id', function (inRequest, inResponse) { return __awaiter(void 0, void 0, void 0, function () {
    var imapWorker, response_2, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                console.log("selectedInbox", inRequest.body);
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                imapWorker = new IMAP.Worker(ServerInfo_1.serverInfo);
                return [4 /*yield*/, imapWorker.getSelectedMailboxMessageBody(parseInt(inRequest.params.id, 10))];
            case 2:
                response_2 = _a.sent();
                inResponse.setHeader('Content-Type', 'text/html');
                inResponse.send(response_2);
                return [3 /*break*/, 4];
            case 3:
                error_2 = _a.sent();
                inResponse.send(error_2);
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
    });
