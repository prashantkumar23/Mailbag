...
var Worker = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        _a.sent();
                        return [2 /*return*/, []];
                    case 4: return [4 /*yield*/, client.listMessages(inCallOptions.mailbox, mailbox.exists - 15 + ":*", ["uid", "envelope"])];
                    case 5:
                        messages = _a.sent();
    ...
    // For GMAIL 
    Worker.prototype.listMessagesOfGmail = function (mailboxName) {
        return __awaiter(this, void 0, void 0, function () {
            var client, mailbox, messages, finalMessages;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log("IMAP.Worker.listMessages()", mailboxName);
                        return [4 /*yield*/, this.connectToServer()];
                    case 1:
                        client = _a.sent();
                        return [4 /*yield*/, client.selectMailbox("[Gmail]/" + mailboxName)];
                    case 2:
                        mailbox = _a.sent();
                        console.log("IMAP.Worker.listMessages(): Message count = " + mailbox.exists);
                        if (!(mailbox.exists === 0)) return [3 /*break*/, 4];
                    ...
                    case 3:
                        _a.sent();
                        return [2 /*return*/, []];
                    case 4: return [4 /*yield*/, client.listMessages("[Gmail]/" + mailboxName, mailbox.exists - 15 + ":*", ["uid", "envelope"])];
                    case 5:
                        messages = _a.sent();
                        messages.sort(function (a, b) {
                            return b.uid - a.uid;
    ...
    Worker.prototype.getMessageBody = function (inCallOptions) {
        return __awaiter(this, void 0, void 0, function () {
            var client, messages, _a, html, subject, date;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        _a = _b.sent(), html = _a.html, subject = _a.subject, date = _a.date;
                        return [4 /*yield*/, client.close()];
                    case 4:
                        _b.sent();
                        return [2 /*return*/, {
    ...
    // TEST ROUTE Function *****************************************************
    Worker.prototype.getSelectedMailbox = function () {
        return __awaiter(this, void 0, void 0, function () {
            var client, draftMailbox, messages, finalMessages;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log("IMAP.Worker.getSelectedMailbox()");
                        return [4 /*yield*/, this.connectToServer()];
                    case 1:
                        client = _a.sent();
                        return [4 /*yield*/, client.selectMailbox('[Gmail]/Starred')];
                    case 2:
                        draftMailbox = _a.sent();
                        return [4 /*yield*/, client.listMessages('[Gmail]/Starred', draftMailbox.exists - 5 + ":*", ["uid", "envelope"])];
                    case 3:
                        messages = _a.sent();
                        messages.sort(function (a, b) {
                            return b.uid - a.uid;
    ...
    Worker.prototype.getSelectedMailboxMessageBody = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var client, messages, parsed;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log("IMAP.Worker.getMessageBody()");
                        return [4 /*yield*/, this.connectToServer()];
                    case 1:
                        client = _a.sent();
                        return [4 /*yield*/, client.listMessages('[Gmail]/Starred', id, ["body[]"], { byUid: true })];
                    case 2:
                        messages = _a.sent();
                        return [4 /*yield*/, mailparser_1.simpleParser(messages[0]["body[]"])];
                    case 3:
